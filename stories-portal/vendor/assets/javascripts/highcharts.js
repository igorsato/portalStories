...
(function(M, a) {
    ...
    (function(a) {
        ...
        a.createElement = function(p, d, g, t, l) {
            p = F.createElement(p);
            var r = a.css;
            d && a.extend(p, d);
            l && r(p, {
        ...
        a.formatSingle = function(p, d) {
            ...
            /f$/.test(p) ? (g = (g = p.match(g)) ? g[1] : -1, null !== d && (d = a.numberFormat(d, g, t.decimalPoint, -1 < p.indexOf(",") ? t.thousandsSep : ""))) : d = a.dateFormat(p, d);
            return d
        };
        ...
        a.offset = function(a) {
            ...
            return {
                top: a.top + (I.pageYOffset || d.scrollTop) - (d.clientTop || 0),
                left: a.left + (I.pageXOffset || d.scrollLeft) - (d.clientLeft || 0)
            }
        };
        a.stop = function(a, d) {
        ...
        a.Color.prototype = {
            ...
            get: function(a) {
                var g = this.input,
                    d = this.rgba,
                    l;
                this.stops ? (l = I(g), l.stops = [].concat(l.stops), E(this.stops, function(d, f) {
    ...
    (function(a) {
        ...
        E.prototype = {
            ...
            init: function(a,
                B) {
                this.element = "span" === B ? l(B) : n.createElementNS(this.SVG_NS, B);
                this.renderer = a
            },
            ...
            colorGradient: function(z, B, c) {
                ...
                if (e) {
                    ...
                    "radialGradient" === e && n && !r(y.gradientUnits) && (q = y, y = H(y, m.getRadialAttr(n, q), {
                        gradientUnits: "userSpaceOnUse"
                    }));
                    for (u in y) "id" !== u && v.push(u, y[u]);
                    for (u in h) v.push(h[u]);
                    v = v.join(",");
                    k[v] ? n = k[v].attr("id") : (y.id = n = a.uniqueKey(), k[v] = Q = m.createElement(e).attr(y).add(m.defs), Q.radAttr = q, Q.stops = [], w(h, function(z) {
                        0 === z[1].indexOf("rgba") ? (b = a.color(z[1]), f = b.get("rgb"), x = b.get("a")) : (f = z[1], x = 1);
                        z = m.createElement("stop").attr({
                            offset: z[0],
                            "stop-color": f,
                            "stop-opacity": x
                        }).add(Q);
            ...
            applyTextOutline: function(a) {
                ...
                (b = a[0]) && "none" !== b && (b = b.replace(/(^[\d\.]+)(.*?)$/g, function(a, z, B) {
                    ...
                    0 === B && (a.setAttribute("x", z.getAttribute("x")), B = z.getAttribute("y"), a.setAttribute("y", B || 0), null === B && z.setAttribute("y", 0));
                    a = a.cloneNode(1);
                    p(a, {
            ...
            on: function(a, B) {
                ...
                h && "click" === a ? (c.ontouchstart = function(a) {
                    ...
                    (-1 === P.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (z.touchEventFired || 0)) && B.call(c, a)
                }) : c["on" + a] = B;
                return this
            },
            ...
            align: function(a, B, c) {
                ...
                var q, h;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = B, !c || x(c)) this.alignTo = z = c || "renderer", k(b, this), b.push(this), c = null
                } else a = this.alignOptions, B = this.alignByTranslate,
                    z = this.alignTo;
                c = D(c, m[z], m);
                z = a.align;
                m = a.verticalAlign;
                    ...
                    if (e.namespaceURI === this.SVG_NS || m.forExport) {
                        try {
                            (h = this.fakeTS && function(a) {
                                w(e.querySelectorAll(".highcharts-text-outline"), function(z) {
                                    z.style.display = a
                                })
                            }) && h("none"), z = e.getBBox ? u({}, e.getBBox()) : {
                                width: e.offsetWidth,
            ...
            shadow: function(a, c, m) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    for (B = 1; B <= q; B++) b = e.cloneNode(0), y = 2 * q + 1 - 2 * B, p(b, {
                        isShadow: "true",
                        ...
                        fill: "none"
                    }), m && (p(b, "height", Math.max(p(b, "height") - y, 0)), b.cutHeight = y), c ? c.element.appendChild(b) : e.parentNode.insertBefore(b,
                        e), z.push(b);
                    this.shadows = z
                }
                return this
            ...
            fillSetter: function(a,
                c, m) {
                "string" === typeof a ? m.setAttribute(c, a) : a && this.colorGradient(a, c, m)
            },
        ...
        A.prototype = {
                    ...
                    w(q, function(e) {
                        if ("" !== e || 1 === q.length) {
                            ...
                            f.test(e) && (g = e.match(f)[1].replace(/(;| |^)color([ :])/,
                                "$1fill$2"), p(D, "style", g));
                            u.test(e) && !z && (p(D, "onclick", 'location.href\x3d"' + e.match(u)[1] + '"'), t(D, {
                                cursor: "pointer"
                            }));
            ...
            arc: function(a, c, m, b, e, y) {
                q(a) && (c = a.y, m = a.r, b = a.innerR, e = a.start, y = a.end, a = a.x);
            ...
            symbol: function(a, c, m, b, e, y) {
                var q = this,
                    ...
                    k = /^url\((.*?)\)$/,
                    x, f;
                z ? (B = this.path(h), B.attr("fill", "none"), u(B, {
                    symbolName: a,
                    x: c,
                    y: m,
                    width: b,
                    height: e
                }), y && u(B, y)) : k.test(a) && (x = a.match(k)[1], B = this.image(x),
                    B.imgwidth = D(O[x] && O[x].width, y && y.width), B.imgheight = D(O[x] && O[x].height, y && y.height), f = function() {
                        B.attr({
                            width: B.width,
                            height: B.height
                        })
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        ...
                        t !== this.cTT && (q = a.fontMetrics(b.style.fontSize).b, I(x) && this.setSpanRotation(x, c, q), F(b, {
                            width: "",
                            whiteSpace: g || "nowrap"
    ...
    (function(a) {
        ...
        a.svg || (A = {
            ...
            getSpanCorrection: function(a, b, e, h, f) {
                ...
                f && "left" !== f && (this.xCorr -= a * e * (0 > c ? -1 : 1), h && (this.yCorr -= x * e * (0 > q ? -1 : 1)), I(this.element, {
                    textAlign: f
                }))
            },
            ...
            clip: function(a) {
                var c = this,
                    b;
                a ? (b = a.members,
                    r(b, c), b.push(c), c.destroyClip = function() {
                        r(b, c)
            ...
            color: function(c, b, e, h) {
                ...
                if (v) {
                    ...
                    1 > t[0] && c.push([1, t[1]]);
                    l(c, function(c, b) {
                        f.test(c[1]) ? (q = a.color(c[1]), m = q.get("rgb"), y = q.get("a")) : (m = c[1], y = 1);
                        w.push(100 * c[0] + "% " + m);
                        b ? (B = y, C = m) : (z = y, g = m)
                    });
                    if ("fill" === e)
                        if ("gradient" === v) e = x.x1 || x[0] || 0, c = x.y1 || x[1] || 0, u = x.x2 || x[2] || 0, x = x.y2 || x[3] || 0, r = 'angle\x3d"' + (90 - 180 * Math.atan((x - c) / (u - e)) / Math.PI) + '"',
                            ...
                            var d = x.r,
                                ...
                                U = b.radialReference,
                                T, d = function() {
                                    U && (T = h.getBBox(), E += (U[0] - T.x) / T.width - .5, I += (U[1] - T.y) / T.height - .5, p *= U[2] / T.width, A *= U[2] / T.height);
            ...
            this.init.apply(this, arguments)
        }, E.prototype = u(C.prototype, A), a.Renderer = E);
    ...
    (function(a) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                }, b.dashStyle && (q.dashstyle = b.dashStyle)) : h && (L && (q.fill = L), b.borderWidth && (q.stroke = b.borderColor, q["stroke-width"] = b.borderWidth));
                D.zIndex = H;
                K += "-" + H;
                ...
                n && F(n.text) && q && q.length && 0 < d.width && 0 < d.height && !q.flat ? (n = g({
                    ...
                    y: f ? h ? 16 : 10 : h ? 6 : -4,
                    rotation: f && !h && 90
                }, n), this.renderLabel(n, q, h, H)) : w && w.hide();
                return a
            },
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            ...
            render: function(a, g, r) {
                ...
                if (!g && C && (e = f.getPlotLinePath(e + D, C.strokeWidth() * N, g, !0))) C[this.isNew ? "attr" : "animate"]({
                    d: e,
                    opacity: r
                });
                c && (f.opposite && (c[0] = -c[0]), x && (this.mark = q = n.path().addClass("highcharts-" + (u ? u + "-" : "") + "tick").add(f.axisGroup), q.attr({
                    stroke: v,
                    "stroke-width": m
                })), q[x ? "attr" : "animate"]({
    ...
    (function(a) {
        ...
        a.Axis.prototype = {
                ...
                b(a.series, function(b) {
                    if (b.visible ||
                        ...
                        if (a.isXAxis) m = b.xData, m.length && (b = I(m), c(b) || b instanceof Date || (m = h(m, function(a) {
                            return c(a)
                        }), b = I(m)), a.dataMin = Math.min(H(a.dataMin, m[0]), b), a.dataMax = Math.max(H(a.dataMax, m[0]), F(m)));
            ...
            zoom: function(a, b) {
                ...
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (l(c) && a <= h && (a = h), l(e) && b >= m && (b = m)), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
            ...
            getOffset: function() {
                ...
                a.axisGroup || (a.gridGroup =
                    ...
                    }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (L || "")).add(J), a.axisGroup = e.g("axis").attr({
                        zIndex: h.zIndex || 2
                    }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (L || "")).add(J), a.labelGroup = e.g("axis-labels").attr({
                        zIndex: G.zIndex || 7
                    }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (L || "")).add(J));
                if (v || a.isLinked) b(k, function(b) {
                        f[b] ? f[b].addLabel() : f[b] = new N(a, b)
                    }), a.renderUnsquish(), !1 === G.reserveSpace || 0 !== d && 2 !== d && {
                        1: "left",
                        3: "right"
                    }[d] !==
                    a.labelAlign && "center" !== a.labelAlign || b(k, function(a) {
                ...
                x && x.text && !1 !== x.enabled && (a.axisTitle || ((p = x.textAlign) || (p = (q ? {
                        low: "left",
                        middle: "center",
                        high: "right"
                    } : {
                        ...
                        middle: "center",
                        high: K ? "left" : "right"
                    })[x.align]), a.axisTitle = e.text(x.text, 0, 0, x.useHTML).attr({
                        zIndex: 7,
                        rotation: x.rotation || 0,
                        align: p
                    }).addClass("highcharts-axis-title").css(x.style).add(a.axisGroup),
            ...
            getTitlePosition: function() {
                ...
                return {
                    x: a ? e + q : b + (f ? this.width : 0) + d + q,
                    y: a ? b + n - (f ? this.height : 0) + d : e + n
                }
            },
            render: function() {
                var a =
                ...
                if (a.hasData() || q) a.minorTickInterval && !a.categories && b(a.getMinorTickPositions(), function(b) {
                        ...
                        if (!q || b >= a.min && b <= a.max) g[b] || (g[b] = new N(a, b)), r && g[b].isNew && g[b].render(c, !0, .1), g[b].render(c)
                    }), G && (0 === a.min || a.single) && (g[-1] || (g[-1] = new N(a, -1, null, !0)), g[-1].render(-1))), x && b(n, function(b, c) {
                        p = void 0 !== n[c + 1] ? n[c + 1] + G : a.max - G;
                        0 === c % 2 && b < a.max && p <= a.max + (e.polar ? -G : G) && (D[b] || (D[b] = new J(a)), H = b + G, D[b].options = {
                            from: f ? d(H) : H,
                            to: f ? d(p) : p,
                            color: x
        ...
        a.Tooltip.prototype = {
            ...
            getPosition: function(a, f, d) {
                var b = this.chart,
                    ...
                    p = function() {
                        !1 !== g.apply(0, v) ? !1 !== l.apply(0, c) || n || (r(!0), p()) : n ? e.x = e.y = 0 : (r(!0), p())
                    };
            ...
            refresh: function(a, f) {
                ...
                !c || a.series && a.series.noSharedTooltip ? n = a.getLabelConfig() : (b.hoverPoints = a, n && A(n, function(a) {
                    ...
                    n = {
                        x: a[0].category,
                        y: a[0].y
                    }, n.points = v, this.len = v.length, a = a[0]);
                n = d.call(n, this);
                c = a.series;
                ...
                }), d.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + t(a.colorIndex, c.colorIndex)), d.attr({
            ...
            renderSplit: function(b, f) {
                ...
                A(b.slice(0, b.length - 1), function(a, b) {
                    ...
                    a -= k.plotTop;
                    n.push({
                        target: b.isHeader ? k.plotHeight + v : a,
                        rank: b.isHeader ? 1 : 0,
                ...
                A(n, function(a) {
                    ...
                    a.tt.attr({
                        ...
                        x: h || b.isHeader ? a.x : b.plotX + k.plotLeft + t(g.distance, 16),
                        y: a.pos + k.plotTop,
        ...
        a.Pointer.prototype = {
            ...
            runPointActions: function(e) {
                ...
                u && (c ? u.noSharedTooltip : u.directTouch) && n ? G = [n] : (c || !u || u.options.stickyTracking ||
                    (f = [u]), t(f, function(a) {
                        ...
                        D = !c && a.directTouch;
                        a.visible && !r && !D && b(a.options.enableMouseTracking, !0) && (K = a.searchPoint(e, !r && 1 === a.kdDimensions)) && K.series && G.push(K)
                    }), G.sort(function(a, b) {
                ...
                if (G[0] && (G[0] !== this.prevKDPoint || k && k.isHidden)) {
                    ...
                    } else if (k && k.refresh(G[0], e), !u || !u.directTouch) G[0].onMouseOver(e);
                    this.prevKDPoint = G[0];
                    d = !1
                }
                d && (f = u && u.tooltipOptions.followPointer, k && f && !k.isHidden && (f = k.getAnchor([{}], e), k.updatePosition({
                    plotX: f[0],
                    plotY: f[1]
                })));
            ...
            reset: function(a, b) {
                var e = this.chart,
                    ...
                    k = e.tooltip,
                    d = k && k.shared ? f : c;
                a && d && t(w(d), function(b) {
                    b.series.isCartesian && void 0 === b.plotX && (a = !1)
                });
                if (a) k && d && (k.refresh(d), c && (c.setState(c.state, !0), t(e.axes, function(a) {
            ...
            drag: function(a) {
                ...
                r && r.touch || (f < g ? f = g : f > g + u && (f = g + u), c < n ? c = n : c > n + D && (c = n + D), this.hasDragged = Math.sqrt(Math.pow(p - f, 2) + Math.pow(m - c, 2)), 10 < this.hasDragged &&
                    (l = b.isInsidePlot(p - g, m - n), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !t && !r && (this.selectionMarker = r = b.renderer.rect(g, n, k ? 1 : u, d ? 1 : D, 0).attr({
                        fill: e.selectionMarkerFill || I("#335cad").setOpacity(.25).get(),
        ...
        F(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, d, l, r, f, b, n, p) {
                var g = this.chart,
                    ...
                    m;
                l = function() {
                    !J && 20 < Math.abs(D - K) && (x = p || Math.abs(G - N) / Math.abs(D - K));
                    q = (v - G) / x + D;
            ...
            pinch: function(a) {
                ...
                }), g.res = !0) : g.followTouchMove && 1 === b ? this.runPointActions(g.normalize(a)) : r.length && (u || (g.selectionMarker = u = F({
                    destroy: p,
                    touch: !0
                }, l.plotBox)), g.pinchTranslate(r, f, k, u, h, n), g.hasPinched = w, g.scaleGroups(k, h), g.res && (g.res = !1, this.reset(!1, 0)))
            },
            touch: function(g, p) {
                var l = this.chart,
                    r, f;
        ...
        E.prototype = {
            ...
            renderItem: function(a) {
                ...
                y || (a.legendGroup = k.g("legend-item").addClass("highcharts-" + P.type + "-series highcharts-color-" + a.colorIndex + (a.options.className ? " " + a.options.className : "") + (O ? " highcharts-series-" +
                    a.index : "")).attr({
                    zIndex: 1
                }).add(this.scrollGroup), a.legendItem = y = k.text("", D ? c + n : -n, this.baseline || 0, B).css(r(a.visible ? l : u)).attr({
                    align: D ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), this.baseline || (l = l.fontSize, this.fontMetrics = k.fontMetrics(l, y), this.baseline = this.fontMetrics.f + 3 + w, y.attr("y", this.baseline)), P.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, y, B), z && this.createCheckboxForItem(a));
            ...
            handleOverflow: function(a) {
                ...
                a > h && !1 !== u.enabled ? (this.clipHeight = n = Math.max(h - 20 - this.titleHeight - K, 0), this.currentPage = f(this.currentPage, 1), this.fullHeight = a, d(m, function(a, b) {
                        ...
                        c !== w && (w = c)
                    }), l || (l = b.clipRect = k.clipRect(0, K, 9999, 0), b.contentGroup.clip(l)), y(n), D || (this.nav = D = k.g().attr({
                        zIndex: 1
                    }).add(this.group), this.up = k.symbol("triangle", 0, 0, p, p).on("click", function() {
                        b.scroll(-1, r)
                    }).add(D), this.pager = k.text("", 15, 10).addClass("highcharts-legend-navigation").css(u.style).add(D), this.down = k.symbol("triangle-down", 0, 0, p, p).on("click", function() {
                        b.scroll(1, r)
                    }).add(D)),
                    b.scroll(0), a = h) : D && (y(), D.hide(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
        ...
        z.prototype = {
            ...
            redraw: function(b) {
                ...
                for (this.layOutTitles(); v--;)
                    if (b = e[v], b.options.stacking && (h = !0, b.isDirty)) {
                        g = !0;
                        break
                    }
                if (g)
            ...
            drawChartBox: function() {
                ...
                y = "animate";
                m || (y = "attr", this.plotBorder = m = b.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                m.attr({
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setData: function(a, c, f, d) {
                ...
                if (!1 !== d && q && n === q && !m.cropped &&
                    !m.hasGroupedData && m.visible) r(a, function(a, b) {
            ...
            setClip: function(a) {
                var b = this.chart,
                    ...
                    n = b[k + "m"];
                g || (a &&
                    (h.width = 0, b[k + "m"] = n = e.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[k] = g = e.clipRect(h), g.count = {
                        length: 0
                    });
            ...
            plotGroup: function(a, b, c, e, f) {
                ...
                h && (this[a] = d = this.chart.renderer.g(b).attr({
                    zIndex: e || .1
                }).add(f), d.addClass("highcharts-series-" +
            ...
            redraw: function() {
                ...
                c && (a.inverted && c.attr({
                    ...
                    translateY: v(f && f.top, a.plotTop)
                }));
                this.translate();
                this.render();
            ...
            getGraphPath: function(a) {
                var d = p.prototype.getGraphPath,
                    ...
                    q = function(b, c, d) {
                        ...
                        void 0 !== l && (u.push({
                            plotX: e,
                            plotY: null === l ? v : f.getThreshold(l),
                            isNull: g
                        }), w.push({
                            plotX: e,
                            plotY: null ===
                ...
                for (b = 0; b < a.length; b++)
                    if (n = a[b].isNull, e = I(a[b].rectPlotX, a[b].plotX), c = I(a[b].yBottom, v), !n || g) g || q(b, b - 1, "left"), n && !r && g || (u.push(a[b]), w.push({
                        x: b,
                        plotX: e,
                        plotY: c
                    })), g || q(b, b + 1, "right");
            ...
            drawGraph: function() {
                ...
                A(r, function(f) {
                    ...
                    g ? (g.endX = d.xMap, g.animate({
                        ...
                        fill: I(f[3], E(f[2]).setOpacity(I(l.fillOpacity, .75)).get()),
                        zIndex: 0
    ...
    (function(a) {
        ...
        l("column", "line", {
            ...
            getColumnMetrics: function() {
                ...
                a.columnMetrics = {
                    width: b,
                    offset: (c - b) / 2 + (v + ((a.columnIndex || 0) + (u ? 1 : 0)) * c - p / 2) * (u ? -1 : 1)
                };
            ...
            animate: function(a) {
                var b = this,
                    ...
                    k = {};
                r && (a ? (k.scaleY = .001, a = Math.min(d.pos + d.len, Math.max(d.pos, d.toPixels(f.threshold))), g ? k.translateX = a - d.len : k.translateY = a, b.group.attr(k)) : (k[g ? "translateX" : "translateY"] = d.pos, b.group.animate(k, I(E(b.options.animation), {
                        step: function(a, d) {
                            b.group.attr({
    ...
    (function(a) {
        ...
        b.prototype.drawDataLabels = function() {
            var a = this,
                ...
                n, x, w = r(e.defer, !0),
                H = a.chart.renderer;
            if (e.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(e), x = a.plotGroup("dataLabelsGroup", "data-labels", w && !c ? "hidden" : "visible", e.zIndex || 6), w && (x.attr({
                opacity: +c
            }), c || E(a, "afterAnimate", function() {
                a.visible && x.show(!0);
                x[b.animation ? "animate" : "attr"]({
                    opacity: 1
                }, {
                    duration: 200
                })
                ...
                if (h && !f) c.dataLabel = h.destroy();
                    ...
                    if (h) F(n) ? (h.attr({
                        text: n
                    }), v = !1) : (c.dataLabel = h = h.destroy(), m && (c.connector = m.destroy()));
                    else if (F(n)) {
                        h = {
        ...
        b.prototype.alignDataLabel = function(a, b, e, d, f) {
            ...
            w && (n = e.style.fontSize, n = g.renderer.fontMetrics(n, b).b, d = p({
                ...
                width: l.width,
                height: l.height
            }), u ? (A = !1, c = g.renderer.rotCorr(n, u), c = {
                ...
                "attr" : "animate"](c).attr({
                align: t
            }), h = (u + 720) % 360, h = 180 < h && 360 > h, "left" === t ? c.y -= h ? l.height : 0 : "center" === t ? (c.x -= l.width / 2, c.y -= l.height / 2) : "right" === t && (c.x -= l.width, c.y -= h ? 0 : l.height)) : (b.align(e, null, d), c = b.alignAttr), A ? this.justifyDataLabel(b, e, c, l, d, f) : r(e.crop, !0) && (w = g.isInsidePlot(c.x, c.y) && g.isInsidePlot(c.x + l.width, c.y + l.height)), e.shape && !u && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
            w || (b.attr({
        ...
        n.pie && (n.pie.prototype.drawDataLabels = function() {
            var d = this,
                ...
                z, B, Q, R, S = [0, 0, 0, 0];
            d.visible && (l.enabled || d._hasPointLabels) && (b.prototype.drawDataLabels.apply(d), I(f, function(a) {
                ...
                if (v)
                    for (d.sortByAngle(b, c - .5), 0 < w && (f = Math.max(0, G - D - w), k = Math.min(G + D + w, h.plotHeight), r = g(b, function(a) {
                            if (a.dataLabel) return t = a.dataLabel.getBBox().height ||
                                21, {
                                    target: a.labelPos[1] - f + t / 2,
                                    size: t,
                                    rank: a.y
                                }
                        }), a.distribute(r, k + t - f)), R = 0; R < v; R++) e = b[R], y = e.labelPos, N = e.dataLabel, Q = !1 === e.visible ? "hidden" : "inherit", u = y[1], r ? void 0 === r[R].pos ? Q = "hidden" : (O = r[R].size, B = f + r[R].pos) : B = u, z = l.justify ? E[0] + (c ? -1 : 1) * (D + w) : d.getX(B < f + 2 || B > k - 2 ? u : B, c), N._attr = {
                        visibility: Q,
                        align: y[6]
                    }, N._pos = {
                        x: z + l.x + ({
                        ...
                        y: B + l.y - 10
                    }, y.x = z, y.y = B, null === d.options.size && (m = N.width, z - m < n ? S[3] = Math.max(Math.round(m - z + n), S[3]) : z + m > q - n && (S[1] = Math.max(Math.round(z +
                ...
                if ((N = a.dataLabel) && N._pos && a.visible) {
                    ...
                    if (b = !t) a.connector = t = h.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(d.dataLabelsGroup), t.attr({
                        "stroke-width": c,
        ...
        n.column && (n.column.prototype.alignDataLabel = function(a, d, e, f, g) {
            ...
            k && (f = t(k), 0 > f.y && (f.height += f.y, f.y = 0), k = f.y + f.height - c.yAxis.len, 0 < k && (f.height -= k), h && (f = {
                x: c.yAxis.len - f.y - f.height,
                y: c.xAxis.len - f.x - f.width,
                width: f.height,
                height: f.width
            }), n || (h ? (f.x += l ? 0 : f.width, f.width = 0) : (f.y +=
            ...
            pan: function(a, b) {
                ...
                g("xy" === b ? [1, 0] : [1], function(b) {
                    ...
                    var d = b.horiz,
                        ...
                        g = g > f;
                    b.series.length && (g || l > Math.min(k.dataMin, k.min)) && (!g || h < Math.max(k.dataMax, k.max)) && (b.setExtremes(l, h, !1, !1, {
                        trigger: "pan"
                    }), e = !0);
                    c[d] = f
                });
        ...
        t(k.prototype, {
            ...
            setState: function(a, b) {
                ...
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (n || k && !1 === l.enabled) || a && m.states && m.states[a] && !1 === m.states[a].enabled)) {
                    ...
                    }(c = g.halo) && c.size ? (v || (f.halo = v = r.renderer.path().add(z ? f.markerGroup : f.group)), v[b ? "animate" : "attr"]({
